      ...
      {subject && (
        ...
        >
          <motion.div 
            ...
            className="w-full max-w-xl bg-[#fffaf0] border border-[#e5e5e5] rounded-[24px] shadow-2xl overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="p-6 border-b border-[#e5e5e5] bg-[#faf5e8] flex items-center justify-between">
              <div className="flex items-center gap-3.5">
                <div className="w-11 h-11 rounded-xl bg-[#0a0a0a] flex items-center justify-center font-bold text-white text-sm font-display shadow-xs">
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold text-[#0a0a0a] font-display">{subject.name}</h3>
                </div>
              </div>
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={onClose}
                className="p-2 rounded-xl text-[#6a6a6a] hover:text-[#0a0a0a] hover:bg-[#e5e5e5]/50 transition"
              >
                <X className="w-5 h-5" />
              </motion.button>
            </div>
                ...
                {platforms.map((pid) => {
                  ...
                  return (
                    <motion.div
                      ...
                      className={`p-4 rounded-[16px] border border-[#e5e5e5] ${cardBg} cursor-pointer transition-shadow shadow-xs hover:shadow-md group flex items-center justify-between gap-4`}
                    >
                      <div className="space-y-1.5 flex-1">
                        <div className="flex items-center gap-2">
                          <span className="px-2.5 py-0.5 rounded-full bg-[#0a0a0a] text-white text-[9px] font-bold uppercase tracking-wider">
                            {p.badge}
                          </span>
                      ...
                      <div className="w-9 h-9 rounded-full bg-[#f5f0e0] group-hover:bg-[#0a0a0a] group-hover:text-white flex items-center justify-center text-[#0a0a0a] transition-all shrink-0">
